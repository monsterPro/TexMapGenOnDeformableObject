...
void main(){
	...
	//gl_FragColor = vec4(varyingImg_coord.z * 255.0, varyingImg_coord.z * 255.0, varyingImg_coord.z * 255.0, 1.0);
	gl_FragColor = vec4(varyingImg_coord.z, varyingImg_coord.z, varyingImg_coord.z, 1.0);
	//gl_FragColor =   vec4(texture2D(tempImg, img_coord).rgb, 1.0);
